...
let donationTotal = runners.reduce(function(total, runners) {
...
// Problem 2
// List of donors of 250 or more dollars
let twofiftyorMore = runners.filter(x => x.donation > 250);

console.log(twofiftyorMore);

// Problem 3
// List of runners with long first names (greater than 7 letters) for custom name tags
let longfname = runners.filter((runner) => runner.first_name.length > 7);

console.log(longfname);